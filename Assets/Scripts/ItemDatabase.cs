...
public class ItemDatabase : MonoBehaviour {
    ...
    void Start() {
       ...
       /* print("*** Item 1 ***");
        ...
        Debug.Log(database[0].Value);
        Debug.Log(database[0].Power);
        Debug.Log(database[0].Defence);
        Debug.Log(database[0].Vitality);
        Debug.Log(database[0].Description);
        Debug.Log(database[0].Stackable);
        Debug.Log(database[0].Rarity);
        ...
        Debug.Log(database[1].Defence);
        Debug.Log(database[1].Vitality);
        Debug.Log(database[1].Description);
        Debug.Log(database[1].Stackable);
        Debug.Log(database[1].Rarity);
